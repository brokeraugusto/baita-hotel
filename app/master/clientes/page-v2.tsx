...
import { Plus, Edit, Trash2, Mail, Settings, AlertCircle } from "lucide-react"
import { useToast } from "@/hooks/use-toast"
import { clientsService } from "@/lib/services/clients-service-v2"
import { useAuth } from "@/lib/auth/auth-context"
import { Alert, AlertDescription } from "@/components/ui/alert"

export default function MasterClientsPageV2() {
  ...
  const handleCreateClient = async () => {
    ...
    if (!isMasterAdmin) {
      toast({
        title: "Acesso negado",
        description: "Apenas master admin pode criar clientes",
        variant: "destructive",
      })
      return
    }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Alert className="max-w-md" variant="destructive">
          <AlertCircle className="h-4 w-4" />
          <AlertDescription>Acesso negado. Apenas master admin pode acessar esta página.</AlertDescription>
        </Alert>
      </div>
    )
  }
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="Starter">Starter - R$ 49,90/mês</SelectItem>
                          <SelectItem value="Professional">Professional - R$ 99,90/mês</SelectItem>
