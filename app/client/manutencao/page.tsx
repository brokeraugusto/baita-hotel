...
import { getMaintenanceOrders, deleteMaintenanceOrder } from "@/lib/services/maintenance-service"
...
export default function MaintenancePage() {
  ...
  // Fetch orders when filters or refreshKey changes
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        ...
        const data = await getMaintenanceOrders(hotelId, options)
        setOrders(data)
      } catch (error) {
    ...
    fetchOrders()
  }, [filters, refreshKey, hotelId, toast])
  ...
  const handleDeleteOrder = async (id: string) => {
    try {
      const success = await deleteMaintenanceOrder(id)
