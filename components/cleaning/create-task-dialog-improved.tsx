...
import { createCleaningTask, getRooms, getCleaningPersonnel } from "@/lib/services/cleaning-service-complete"
...
export function CreateTaskDialogImproved({ isOpen, onClose, onSuccess, hotelId }: CreateTaskDialogProps) {
