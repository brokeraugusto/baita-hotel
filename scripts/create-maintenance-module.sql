...
CREATE TABLE maintenance_orders (
  ...
  -- Relationships
  hotel_id VARCHAR(255) NOT NULL, -- Using VARCHAR to match existing system
  ...
  -- Additional fields
  urgency_reason TEXT, -- Why is it urgent?
...
CREATE INDEX idx_maintenance_orders_completed_at ON maintenance_orders(completed_at);
...
-- Insert default maintenance technicians
