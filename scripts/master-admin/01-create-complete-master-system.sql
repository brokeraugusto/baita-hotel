-- Criar sistema completo Master Admin
-- Primeiro, vamos garantir que todas as tabelas sejam criadas

-- 1. Tabela de planos (já existe, vamos apenas adicionar colunas faltantes)
...
-- 5. Tabela de configurações da landing page
...
-- 8. Ajustar tabela support_tickets (adicionar colunas faltantes)
...
-- 9. Tabela de mensagens dos tickets
